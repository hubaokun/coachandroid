...
public class OverScrollView extends ScrollView {
	 ...
	 * ScaleHalo监听
	 */
	private OnScaleHaloListener mScaleHaloListener;

	/**
	 * 最新一次的手指触摸位置
	 */
	private float mLastMotionY; // overscroll下
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			if (isRecord) {
				...
				// 通知haloview刷新
				if (mScaleHaloListener != null) {
					mScaleHaloListener.transform(-overScrollDistance);
				}
				return false;
			}
			break;
		...
		case MotionEvent.ACTION_UP:
			...
			// 重置haloview
			if (mScaleHaloListener != null) {
				mScaleHaloListener.transform(0);
			}
			break;
	...
	public void setScaleHaloListener(OnScaleHaloListener listener) {
		mScaleHaloListener = listener;
	}

	public boolean ismIsBanScroll() {
		return mIsBanScroll;
	}

	public void setmIsBanScroll(boolean mIsBanScroll) {
		this.mIsBanScroll = mIsBanScroll;
	}
	...
	public OverScrollWarpLayout getmContentLayout() {

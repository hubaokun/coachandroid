...
public class PickerView extends View {
	...
	private int mSelectColorText = 0x3a95e6;
	...
	private void init() {
		...
		mSelectPaint.setColor(mSelectColorText);
	}
	...
	private void drawData(Canvas canvas) {
		...
		mSelectPaint.setTextSize(size);
		mSelectPaint.setAlpha((int) ((mMaxTextAlpha - mMinTextAlpha) * scale + mMinTextAlpha));
		...
		canvas.drawText(mDataList.get(mCurrentSelected), x, baseline, mSelectPaint);
		// 绘制上方data
